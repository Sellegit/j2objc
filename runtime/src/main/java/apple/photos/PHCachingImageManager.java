...
public class PHCachingImageManager 
    ...
    public native void startCachingImagesForAssets(NSArray<?> assets, CGSize targetSize, @Representing("PHImageContentMode") long contentMode, PHImageRequestOptions options);
