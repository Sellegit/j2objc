...
@Library("Photos") @Mapping("PHAssetCollection")
public class PHAssetCollection 
    ...
    public static native PHFetchResult fetchAssetCollectionsWithLocalIdentifiers(List<String> identifiers, PHFetchOptions options);
