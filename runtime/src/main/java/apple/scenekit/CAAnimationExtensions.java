...
/*<javadoc>*/
/*</javadoc>*/
@Library("SceneKit/SceneKit.h") @Mapping("CAAnimation")
public final class CAAnimationExtensions 
    ...
    @ExtensionMapping("setUsesSceneTimeBase:")
    ...
    @ExtensionMapping("setFadeInDuration:")
    ...
    @ExtensionMapping("setFadeOutDuration:")
