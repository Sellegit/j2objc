...
public abstract class ABPeoplePickerNavigationControllerDelegateAdapter 
    ...
    public void didSelectPerson(ABPeoplePickerNavigationController peoplePicker, ABRecord person) { throw new UnsupportedOperationException(); }
    /**
     * @since Available in iOS 8.0 and later.
     */
    @NotImplemented("peoplePickerNavigationController:didSelectPerson:property:identifier:")
    public void didSelectPerson(ABPeoplePickerNavigationController peoplePicker, ABRecord person, int property, int identifier) { throw new UnsupportedOperationException(); }
    ...
    public boolean shouldContinueAfterSelectingPerson(ABPeoplePickerNavigationController peoplePicker, ABRecord person) { throw new UnsupportedOperationException(); }
    /**
     * @since Available in iOS 2.0 and later.
     * @deprecated Deprecated in iOS 8.0.
     */
    ...
    public boolean shouldContinueAfterSelectingPerson(ABPeoplePickerNavigationController peoplePicker, ABRecord person, int property, int identifier) { throw new UnsupportedOperationException(); }
