...
public final class UIImagePickerControllerSourceType extends ObjCEnum {
    ...
    @GlobalConstant("UIImagePickerControllerSourceTypePhotoLibrary")
    public static final long PhotoLibrary = 0L;
    @GlobalConstant("UIImagePickerControllerSourceTypeCamera")
