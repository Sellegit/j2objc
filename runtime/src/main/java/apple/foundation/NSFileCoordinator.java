...
public class NSFileCoordinator 
    ...
    public native void coordinateReadingItem(NSURL url, @Representing("NSFileCoordinatorReadingOptions") long options, Todo outError, @Block VoidBlock1<NSURL> reader);
    @Mapping("coordinateWritingItemAtURL:options:error:byAccessor:")
    public native void coordinateWritingItem(NSURL url, @Representing("NSFileCoordinatorWritingOptions") long options, Todo outError, @Block VoidBlock1<NSURL> writer);
    @Mapping("coordinateReadingItemAtURL:options:writingItemAtURL:options:error:byAccessor:")
    public native void coordinateReadingItem(NSURL readingURL, @Representing("NSFileCoordinatorReadingOptions") long readingOptions, NSURL writingURL, @Representing("NSFileCoordinatorWritingOptions") long writingOptions, Todo outError, @Block VoidBlock2<NSURL, NSURL> readerWriter);
    @Mapping("coordinateWritingItemAtURL:options:writingItemAtURL:options:error:byAccessor:")
    public native void coordinateWritingItem(NSURL url1, @Representing("NSFileCoordinatorWritingOptions") long options1, NSURL url2, @Representing("NSFileCoordinatorWritingOptions") long options2, Todo outError, @Block VoidBlock2<NSURL, NSURL> writer);
    @Mapping("prepareForReadingItemsAtURLs:options:writingItemsAtURLs:options:error:byAccessor:")
    public native void prepareForReadingItems(NSArray<?> readingURLs, @Representing("NSFileCoordinatorReadingOptions") long readingOptions, NSArray<?> writingURLs, @Representing("NSFileCoordinatorWritingOptions") long writingOptions, Todo outError, @Block("(@Block)") VoidBlock1<Runnable> batchAccessor);
    /**
